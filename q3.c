...
int main(){
    ...
    for (cateto1 = 1; cateto1 <= valor; cateto1++) {
        for (cateto2 = cateto1; cateto2 <= valor; cateto2++){  //Iniciamos dois loops aninhados: o primeiro loop itera pelo cateto1, variando de 1 até o valor máximo fornecido (valor). O segundo loop itera pelo cateto2, iniciando a partir do valor de cateto1 atual e também indo até o valor máximo.
